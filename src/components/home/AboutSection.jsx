        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            <div className="absolute -bottom-6 -right-6 bg-accent text-primary p-6 rounded-lg shadow-xl">
              ...
              <p className="font-body text-xs font-bold uppercase tracking-wider mt-1">{tr.about_since}</p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            <span className="font-body text-sm font-bold uppercase tracking-widest text-secondary">{tr.about_badge}</span>
            <h2 className="text-[hsl(var(--chart-3))] mt-3 mb-6 text-5xl font-heading sm:text-6xl">
              {tr.about_title_1} <span className="text-[hsl(var(--accent))]">{tr.about_title_2}</span>
            </h2>
