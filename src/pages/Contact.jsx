                ...
                {sent ? (
                  <div className="bg-secondary/10 border border-secondary/30 rounded-lg p-12 text-center">
                    ...
                    <h3 className="font-heading text-3xl text-foreground mb-2">
                      {tr.contact_sent_title}
                    </h3>
                    <p className="font-body text-muted-foreground">
                      {tr.contact_sent_desc}
                    </p>
                  </div>
                ) : (
                  <form
                  ...
                  >
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        <label className="font-body text-xs font-bold uppercase tracking-wider text-muted-foreground mb-2 block">
                          {tr.contact_name}
                        </label>
                        <Input
                          value={form.name}
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-accent hover:bg-accent/90 text-primary font-body font-bold uppercase tracking-wider py-6"
                    >
